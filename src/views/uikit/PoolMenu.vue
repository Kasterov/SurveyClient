...
onMounted(async () => {
    postMenuContent.value = await getPostMenu();
...
const deletePostById = async () => {
    ...
    postMenuContent.value = postMenuContent.value.filter((post) => post.id !== postToDeleteId.value);
